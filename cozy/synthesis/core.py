        ...
        while True:
            ...
            if counterexample is not None:
                if counterexample in examples:
                    ...
                    print("old fp = {}".format(learner.fingerprint(old_e)))
                    print("new fp = {}".format(learner.fingerprint(new_e)))
                    print("old target fp = {}".format(learner.fingerprint(target)))
                    print("new target fp = {}".format(learner.fingerprint(new_target)))
