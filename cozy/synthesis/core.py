...
def _consider_replacement(
    ...
    if isinstance(e, EOrderedElems) and isinstance(e.e, EStateVar) and \
            isinstance(replacement, EStateVar) and isinstance(replacement.e, EOrderedElems):
        # FIXME(zhen): current enumerator will always try to make EOrderedElems a state var
